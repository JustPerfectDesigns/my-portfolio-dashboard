		...
		<div className="md:sticky md:top-0 z-50 text-white">
          ...
          md:-translate-y-full"
			>
				...
				>
					<MdOutlineGridView className="text-[1.7rem]" />
				</button>
			</div>
			<div
				ref={sideBarRef}
			...
			>
				<div>
					<Link
						href="/"
						className="block logo mb-12"
						onClick={navClickHideSidebar}
					>
						<GabLogo
							width={100}
							height={100}
							className="mb-4 w-[150px] text-[#121212] dark:text-white"
						/>
					</Link>
							...
							>
      						...
      						>
								...
								{theme === "dark" ? (
									<button
										onClick={themeLight}
										className="dark:bg-black-container bg-[#F6F8FA] flex justify-center items-center p-4 gap-2 rounded-full"
									>
										<BiSun className="text-2xl text-black-container dark:text-[#F6F8FA]" />{" "}
									...
									<button
										...
										className="dark:bg-black-container bg-[#F6F8FA] flex justify-center items-center p-4 gap-2 rounded-full"
									>
										<BiMoon className="text-2xl text-black-container dark:text-[#F6F8FA]" />{" "}
										<span className="text-black-container dark:text-[#F6F8FA] font-medium">
											Dark Mode
										</span>
									</button>
								)}
